...
First we create the posterior database to use, here we can use the database locally (after cloning the repo).
...
See [DATABASE_CONTENT.md](https://github.com/MansMeg/posteriordb/blob/master/DATABASE_CONTENT.md) for the details content of the posterior database.
