...
writeLines(jsonlite::toJSON(eightschools, pretty = TRUE, auto_unbox = TRUE), con = "eight_schools.json")
zip(zipfile = "eight_schools.json.zip", files = "eight_schools.json")
...
jsonlite::write_json(data_info, "eight_schools.info.json", pretty = TRUE)
