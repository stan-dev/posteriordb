...
eval_points_noncentered <- draws_noncentered[eval_indices, 1:(ncol(draws_noncentered) - 1)]
...
write.csv(eval_points_centered, "eval_points_centered.csv", row.names = FALSE)
write.csv(log_probs_centered, "log_probs_centered.csv", row.names = FALSE)
write.csv(grads_centered, "grads_centered.csv", row.names = FALSE)

write.csv(eval_points_noncentered, "eval_points_noncentered.csv", row.names = FALSE)
write.csv(log_probs_noncentered, "log_probs_noncentered.csv", row.names = FALSE)
write.csv(grads_noncentered, "grads_noncentered.csv", row.names = FALSE)
